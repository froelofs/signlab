...
nonmansOrder = ["</shoulder_tier>", "</body_tier>", "</head_tier>","</eyegaze_tier>","</facialexpr_tier>","</mouthing_tier>"]
...
if __name__ == '__main__':
    # print("output sigml: ", main('U <EM_SADNESS> ETEN KLAAR </EM_SADNESS> HEBBEN'))
